...
def load_input(input_directory):
    ...
    sequence = []
    with fileinput.input(files=files) as f: # lee un archivo y despues le secuencialmente los archivos 
        for line in f: 
...
def line_preprocessing(sequence):
    ...
    sequence = [
        (key, value.translate(str.maketrans("", "", string.punctuation))) #agregar 
...
def mapper(sequence):
    ...
    # como contar cuantas palabras por texto en grandes volumenes de datos 
...
def reducer(sequence):
    """Reducer"""
  # devolver valores en duplas de listas, si iba 1 en cada uno y hay 3 diferentes mostrara ya los 3 
    diccionario = {}
    for key, value in sequence:
